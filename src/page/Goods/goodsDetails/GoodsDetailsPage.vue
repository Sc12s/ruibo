  ...
  <div class="goods_content_box">
    ...
    <ul class="store_name_box">
      <li>
        <a-avatar
          :size="56"
          src="http://localhost:3000/image/selflogo/%E5%95%86%E5%BA%97.png"
        ></a-avatar>
      </li>
      <li>
        {{ storeName==='自营' ? '瑞博直营店' : storeName }}
      </li>
...
import { defineAsyncComponent, onMounted, reactive, ref, toRefs } from "vue-demi";
...
const GoodsDetailsComp = defineAsyncComponent(
  () => import("./DetailsComp/GoodsDetailsComp.vue")
);
// 异步加载评论详情组件
const GoodsCommentComp = defineAsyncComponent(
  () => import("./DetailsComp/goodsCommentComp.vue")
);
